...
-- | A route pattern is represented by a list of segments.
newtype RoutePattern = RoutePattern [RouteSegment]
    deriving (Show, Eq)

-- | The result from matching a uri with some route pattern.
