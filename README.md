...
Let ![equation](http://latex.codecogs.com/gif.latex?f) be an endofunction on a set ![equation](http://latex.codecogs.com/gif.latex?S). Then ![equation](http://latex.codecogs.com/gif.latex?f) is idempotent, iff,
